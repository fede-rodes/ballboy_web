...
const TermsPage: React.FunctionComponent = () => (
  <Layout title="Terms of Service | Next.js + TypeScript Example">
    ...
    <p>
        ...
        govern your relationship with Ballboy mobile application
        (the "Service") operated by Ballboy ("us", "we", or "our").
    </p>

    <p>
        Please read these Terms and Conditions carefully before using
        our Ballboy mobile application (the "Service").
    </p>
    ...
    <p>
        ...
        exclusive property of Ballboy and its licensors. The Service
        is protected by copyright, trademark, and other laws of both the
        Netherlands and foreign countries. Our trademarks and trade
        dress may not be used in connection with any product or service
        without the prior written consent of Ballboy.
    </p>
    ...
    <p>
        ...
        services that are not owned or controlled by Ballboy.
    </p>

    <p>
        Ballboy has no control over, and assumes no responsibility
        for, the content, privacy policies, or practices of any third
        party web sites or services. You further acknowledge and agree
        that Ballboy shall not be responsible or liable, directly or
    ...
    <p>
        In no event shall Ballboy, nor its directors, employees,
    ...
    <p>
        Ballboy its subsidiaries, affiliates, and its licensors do
    ...
    <p>
        ...
        the laws of Netherlands, without regard to its conflict of law
        provisions.
    </p>
